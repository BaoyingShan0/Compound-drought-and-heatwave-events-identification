...
function [idx]=PRM2_heatwave_identification(Date, index, start_th, end_th, REMO, MERG)

%%
% change 11.3, try the one severity threshold for merging
% changing from drought identification code
...
% % Ä¬ÈÏÖµÊÇÉ¶
% Date=Date(366:end,: );
% index=New_index(366:end);
% start_th=-0.7;
% end_th=0;
% REMO_time=14; % key point, how to defined this time threshold?
% REMO_th=-1.5;
% MERG_time=14; % key point, how to defined this time threshold?
% MERG_th=0.7;
...
% 
% title(' Final identified heatwave events');
% xlabel('Date'); ylabel('Heatwave index');
